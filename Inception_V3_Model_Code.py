...
data_dir = "/soe/mbriden/cmps240/venv_eeg/EEG_Alcoholism_Classification/Data/s1_sep_images/train_val_balanced"
...
optimizer_ft = optim.SGD(params_to_update, lr=0.001, momentum=0.9,weight_decay=0.005)
#optimizer_ft = optim.RMSprop(params_to_update, lr = 0.045, alpha = 0.9,eps=1,weight_decay=0.94)
#optimizer_ft = optim.Adagrad(params_to_update, lr=0.0007, lr_decay=0.00004, weight_decay=0.04)
...
torch.save(model_ft.state_dict(), "/soe/mbriden/cmps240/venv_eeg/inception_s1_full_pretrain_w_even_data_lr=0.001_decay=0.005-80-90s.pt")
